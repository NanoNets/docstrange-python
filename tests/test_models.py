...
from docstrange._utils import PropertyInfo
from docstrange._compat import PYDANTIC_V1, parse_obj, model_dump, model_json
from docstrange._models import DISCRIMINATOR_CACHE, BaseModel, construct_type
